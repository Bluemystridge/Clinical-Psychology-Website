...
export function Services() {
  const services = [
    ...
    { title: 'Couples Therapy', icon: '👥', desc: 'Support for relationship issues and communication' },
    { title: 'Crisis Support', icon: '🆘', desc: 'Immediate mental health support during difficult times' },
  ]
